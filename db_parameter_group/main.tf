...
locals {
  default_map_keys = {
    "Name" = "${data.template_file.name_prefix_tpl.rendered}${var.delimiter}${var.db_parameter_group_name}"
  }
}
...
resource "aws_db_parameter_group" "db_parameter_group" {
  ...
  description = "Managed by Terraform - ${data.template_file.name_prefix_tpl.rendered}${var.delimiter}${var.db_parameter_group_name}"
  dynamic "parameter" {
